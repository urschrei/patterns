...
On a 3.4 GHz Core i7, the optimised version runs in **275 ms**.  
...
The unoptimised version, which uses no parallelism and the standard hash function, runs in **750 ms**.
